        ...
        <div class="row justify-content-center mb-5">
            <div class="col-sm-6 col-xs-12 col-lg-4 mt-5 d-flex" >
                <div class="card border" style="background: #00334d">
                    <div class="d-flex justify-content-center mt-5">
                        <img class="img-fluid" src="https://images.unsplash.com/photo-1606787365321-53019dba74d8?ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Image Vida"/>
                    </div>
                ...
                <div class="card border" style="background: #005580">
                    ...
                    <div class="card text-right" style="background: #005580">      
                        <div class="card-body">
                            ...
                            <a href="https://auto.segurosfalabella.com.co/todo-riesgo/chat-lia" class="btn btn-outline-light" target="_blank">>Ver más</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xs-12 col-lg-4 mt-5 d-flex" >
                <div class="card border" style="background: #0077b3">
                    <div class="d-flex justify-content-center mt-5">
                        <img class="img-fluid" src="https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1350&q=80" alt="Image Dese"/>
                    </div>
                    ...
                    <div class="card text-right" style="background: #0077b3">      
                        <div class="card-body">
                            ...
                            <a href="https://web.segurosfalabella.com/co/otros-seguros/seguro-de-desempleo/" class="btn btn-outline-light" target="_blank">>Ver más</a>
                        </div>
                    </div>
                </div>
            </div>
